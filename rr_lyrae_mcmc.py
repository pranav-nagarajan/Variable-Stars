...
mcmc_parser.add_argument('zero_point', type = int, help = "Theoretical zero point.")
mcmc_parser.add_argument('zp_error', type = int, help = "Uncertainty in theoretical zero point.")
mcmc_parser.add_argument('mean_metallicity', type = int, help = "Mean metallicity in galaxy.")
mcmc_parser.add_argument('sd_metallicity', type = int, help = "Standard deviation of metallicity in galaxy.")
