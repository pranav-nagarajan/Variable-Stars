...
python rr_lyrae_mcmc.py --num_cpus $SLURM_CPUS_PER_TASK --data sculptor_mcmc.csv --data and_one_mcmc.csv --data and_two_mcmc.csv --data and_three_mcmc.csv --data and_fifteen_mcmc.csv --data and_twenty_eight_mcmc.csv --data crater_mcmc.csv --data cetus_mcmc.csv --data tucana_mcmc.csv --data ic_mcmc.csv --data NGC_5824_mcmc.csv --data M4_mcmc.csv --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --metal -1.50 1.0 --calibrate milky_way_mcmc.csv
