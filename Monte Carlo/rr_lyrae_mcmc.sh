...
python rr_lyrae_mcmc.py --num_cpus $SLURM_CPUS_PER_TASK --data sculptor_mcmc.csv --data and_one_mcmc.csv --data and_two_mcmc.csv --data and_three_mcmc.csv --data and_fifteen_mcmc.csv --data and_twenty_eight_mcmc.csv --data crater_mcmc.csv --data cetus_mcmc.csv --data tucana_mcmc.csv --data ic_mcmc.csv --data NGC_5824_mcmc.csv --data M4_mcmc.csv --metal -1.90 1.0 --metal -1.45 1.0 --metal -1.64 1.0 --metal -1.81 1.0 --metal -1.80 1.0 --metal -1.84 1.0 --metal -1.92 1.0 --metal -1.90 1.0 --metal -1.95 1.0 --metal -1.60 1.0 --metal -1.97 1.0 --metal -1.07 1.0 --calibrate milky_way_mcmc.csv
