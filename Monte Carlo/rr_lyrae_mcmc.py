...
with rr_lyrae_model:
    ...
    zero_point = pm.Normal('zero_point', mu = -0.94, sd = 0.2)
    period_slope = pm.Normal('period_slope', mu = -2.43, sd = 0.2)
    metal_slope = pm.Normal('metallicity_slope', mu = 0.15, sd = 0.2)
